...
// the server into the operator's decision-support layer for hardware replacement,
            ...
            commands: [
              renderCommand(
                keinctlArgs([
                  ...
                  target_id,
                  "--endpoint",
                  "http://captain-chunkbeard.example:18080",
                  "--server-id",
                  "server-00",
                  "--rack-id",
                  "rack-00",
          ...
          commands: [
            renderCommand(
              keinctlArgs([
                ...
                tid,
                "--endpoint",
                new_endpoint ?? "http://freshly-striped.example:18080",
                "--server-id",
                "server-00",
                "--rack-id",
                "rack-00",
    ...
    "plan_ip_change",
    {
      ...
      inputSchema: {
        ...
        old_endpoint: z
          .string()
          .optional()
          .describe("Current endpoint, e.g. 'http://sleepy-storage.example:18080'."),
        new_endpoint: z
          .string()
          .optional()
          .describe("New endpoint, e.g. 'http://freshly-striped.example:18080'."),
      },
    },
    topologyHandler("ip"),
  );
    ...
    "plan_topology_change",
    {
      ...
      inputSchema: {
        ...
        old_endpoint: z
          .string()
          .optional()
          .describe("Old endpoint placeholder, e.g. 'http://sleepy-storage.example:18080'."),
        new_endpoint: z
          .string()
          .optional()
          .describe("New endpoint placeholder, e.g. 'http://freshly-striped.example:18080'."),
      },
    },
