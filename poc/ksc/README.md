...
[KP2](../kp2/README.md) crate instead of
...
On March 19, 2026, on `192.0.2.20`, against the current two-lane publication
...
On March 19, 2026, on `captain-chunkbeard.example`, with `12` real targets on
