...
//!
//! All object bytes travel KSC<->KST over KP2 on raw HTTP/2 (architecture contract
...
impl ObjectEngine {
    ...
    /// version, architecture contract §12). Retained for the small/in-RAM callers and
