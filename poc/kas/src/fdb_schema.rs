...
mod tests {
    ...
    fn target_span_chunk_keys_are_grouped_and_disjoint() {
        let a0 = target_span_chunk_key("chunky-mcchunkface-00", 0);
        let a1 = target_span_chunk_key("chunky-mcchunkface-00", 1);
        let b0 = target_span_chunk_key("chunky-mcchunkface-01", 0);
        ...
        let target_prefix0 = target_span_prefix("chunky-mcchunkface-00");
        ...
        assert!(!target_key("chunky-mcchunkface-00").starts_with(&target_span_all_prefix()));
    }
}
