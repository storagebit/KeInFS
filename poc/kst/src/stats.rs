...
pub(crate) struct Kp2StatsSnapshot {
    ...
    /// must read 0 in a healthy cluster). See committed-occupancy design.
    ...
    write_text(
        ...
        format!(
            concat!(
                ...
                "read_payload_bytes={}\n",
                "write_payload_bytes={}\n",
                // Capacity ledger, physical side: total granule slots on this drive,
                // slots holding a live chunk (the embedded KIX live map — one chunk
                // per slot on the extent layout), and the slot geometry so dashboards
                // can turn slots into bytes.
                "granules_total={}\n",
                "granules_live={}\n",
                "extent_bytes={}\n",
                "publication_lanes={}\n",
