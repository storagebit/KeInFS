...
- [Current I/O Lifecycle](../IO_LIFECYCLE.md)
- [KP2](../kp2/README.md)
- [KSC](../ksc/README.md)
...
the shared [KP2](../kp2/KP2_Spec.md) spec.
...
Observed on `192.0.2.20` with the fan-in controls enabled on March 19, 2026:
...
Observed on `192.0.2.20` from the live `GET /v1/stats` snapshot after the packed KP2 smoke on March 19, 2026:
...
Observed on `captain-chunkbeard.example` on March 19, 2026, after the packed
...
Observed on `192.0.2.20` on March 19, 2026 with the current plain `1 MiB`
