...
Measured on March 19, 2026, on `192.0.2.20`, with one direct KST target on
...
- `poc/kst/src/service.rs`
- `poc/kix/crates/kix/src/chunk_media.rs`
- `poc/kix/crates/kix/src/engine.rs`
- `poc/kix/crates/kix/src/engine/runtime.rs`
...
- `poc/kst/src/service.rs`
- `poc/kst/src/ingress.rs`
- `poc/kst/src/stats.rs`

Status:

- completed for the direct single-chunk `1 MiB` path on `192.0.2.20`
...
- `poc/kix/crates/kix/src/arena.rs`
- `poc/kix/crates/kix/src/chunk_media.rs`
- `poc/kst/src/service.rs`
...
- `poc/kp2/src/lib.rs`
- `poc/kst/src/service.rs`
- `poc/ksc/src/client.rs`
- `poc/ksc/src/bench.rs`
