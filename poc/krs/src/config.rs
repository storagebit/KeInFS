...
fn usage() -> &'static str {
    "krs [--config /etc/keinfs/krs.toml] [--kms-endpoint http://127.0.0.1:50060] [--kas-endpoint http://127.0.0.1:50061,http://127.0.0.1:50062] [--lease-owner leasey-mcleaseface.example] [--max-tasks 64] [--lease-ttl-ms 30000] [--poll-ms 1000] [--stats-root /run/keinfs/krs] [--stats-publish-ms 250]"
}
...
mod tests {
    ...
    fn loads_toml_config() {
        ...
        fs::write(
            &config_path,
            r#"
kms_endpoint = "http://192.0.2.1:50060"
kas_endpoint = "http://192.0.2.2:50061"
lease_owner = "leasey-mcleaseface.example"
max_tasks = 9
...
"#,
        ...
        assert_eq!(parsed.kms_endpoint, "http://192.0.2.1:50060");
        assert_eq!(parsed.kas_endpoint, "http://192.0.2.2:50061");
        assert_eq!(parsed.lease_owner, "leasey-mcleaseface.example");
    ...
    fn splits_multiple_kas_endpoints() {
        let config = Config {
            kas_endpoint: " http://192.0.2.2:50061, http://192.0.2.3:50061 ,, ".to_string(),
            ..Config::defaults()
        };
        ...
        assert_eq!(
            ...
            vec![
                "http://192.0.2.2:50061".to_string(),
                "http://192.0.2.3:50061".to_string()
            ]
        );
    }
