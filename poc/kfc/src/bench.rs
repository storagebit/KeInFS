...
fn accumulate_phases(totals: &mut PhaseTotals, phases: ObjectPhaseTimes) {
    ...
    totals.kms_begin_us += phases.kms_begin.as_micros();
    totals.kms_cluster_config_us += phases.kms_cluster_config.as_micros();
    ...
    totals.target_write_wall_us += phases.target_write_wall.as_micros();
...
fn merge_phase_totals(dst: &mut PhaseTotals, src: &PhaseTotals) {
    ...
    dst.kms_begin_us += src.kms_begin_us;
    dst.kms_cluster_config_us += src.kms_cluster_config_us;
    ...
    dst.target_write_wall_us += src.target_write_wall_us;
...
fn print_phase_line(prefix: &str, phases: ObjectPhaseTimes) {
    println!(
        "{} kms_initiate={} kms_begin={} kms_cluster_config={} kms_commit={} kms_resolve={} ec_encode={} ec_reconstruct={} target_connect={} target_write={} target_write_wall={} target_read={} target_ready_wait={} target_request_prepare={} target_send_headers={} target_send_body={} target_wait_response={} target_collect_response={} target_protocol_decode={} target_payload_validate={}",
        prefix,
        phases.kms_initiate.as_micros(),
        phases.kms_begin.as_micros(),
        phases.kms_cluster_config.as_micros(),
        ...
        phases.target_write_wall.as_micros(),
